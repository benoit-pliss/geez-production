...
<template>
    <div class="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8" data-theme="light">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            <img class="mx-auto h-32 w-auto" src="../../../img/logo/logo-geez-dark.png" alt="Geez Production" />
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <div class="space-y-6">
                <div>
                    ...
                    <div class="mt-2">
                        <input id="email" name="email" type="email" autocomplete="email" v-model="formData.email" required="" class="block w-full rounded-md border-0 py-1.5 px-2.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input id="password" name="password" type="password" autocomplete="current-password" v-model="formData.password" required="" class="block w-full rounded-md border-0 py-1.5 px-2.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                    </div>
                </div>
