<template>
    ...
    <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
      <div class="xl:grid xl:grid-cols-3 xl:gap-8">
        <img class="h-32" src="../../../public/logo-geez.png" alt="Geez Production" />
        <div class="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
          <div class="md:grid md:grid-cols-2 md:gap-8">
            <div>
              <h3 class="text-sm font-semibold leading-6 text-white">Geez Production</h3>
            ...
            <div class="mt-10 md:mt-0">
              <h3 class="text-sm font-semibold leading-6 text-white">Partenariats</h3>
              <ul role="list" class="mt-6 space-y-4">
          ...
          <div class="md:grid md:grid-cols-2 md:gap-8">
            ...
            <div class="mt-10 md:mt-0">
              <h3 class="text-sm font-semibold leading-6 text-white">Juridique</h3>
              <ul role="list" class="mt-6 space-y-4">
